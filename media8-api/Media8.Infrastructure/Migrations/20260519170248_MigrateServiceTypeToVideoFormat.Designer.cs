...
namespace Media8.Infrastructure.Migrations
{
    ...
    [Migration("20260519170248_MigrateServiceTypeToVideoFormat")]
    partial class MigrateServiceTypeToVideoFormat
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "complexity_level", new[] { "standard", "premium", "god_mode" });
            ...
            modelBuilder.Entity("Media8.Domain.Entities.VideoFormat", b =>
                {
                    ...
                    b.ToTable("video_formats", (string)null);
                });
            ...
            modelBuilder.Entity("PackageVideoFormat", b =>
                {
                    ...
                    b.ToTable("package_video_formats", (string)null);
                });
