...
namespace Media8.Infrastructure.Migrations
{
    ...
    [Migration("20260529205900_AddIsArchivedToClientContracts")]
    partial class AddIsArchivedToClientContracts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "invoice_status", new[] { "pending", "paid", "overdue", "cancelled" });
            ...
            modelBuilder.Entity("Media8.Domain.Entities.BrandingProfile", b =>
                {
                    ...
                    b.HasIndex("UserId", "SequentialId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Media8.Domain.Entities.ClientContract", b =>
                {
                    ...
                    b.HasIndex("ClientId", "SequentialId")
                        .IsUnique();

                    b.ToTable("ClientContracts", (string)null);
                });

            modelBuilder.Entity("Media8.Domain.Entities.ClientSequence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ClientId", "EntityType")
                        .IsUnique();

                    b.ToTable("ClientSequences", (string)null);
                });
            ...
            modelBuilder.Entity("Media8.Domain.Entities.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Media8.Domain.Entities.ServiceBalanceLot", b =>
                {
                    ...
                    b.HasOne("Media8.Domain.Entities.Invoice", "Invoice")
                        .WithMany()
